    ...
    <x-filament::section>
        ...
        <ul class="space-y-3">
            <li class="flex items-center gap-3">
                <x-filament::icon
                    :icon="$status['chatbot_created'] ? 'heroicon-o-check-circle' : 'heroicon-o-square'"
            ...
            <li class="flex items-center gap-3">
                <x-filament::icon
                    :icon="$status['plugin_installed'] ? 'heroicon-o-check-circle' : 'heroicon-o-square'"
            ...
            <li class="flex items-center gap-3">
                <x-filament::icon
                    :icon="$status['first_sync_done'] ? 'heroicon-o-check-circle' : 'heroicon-o-square'"
            ...
            <li class="flex items-center gap-3">
                <x-filament::icon
                    :icon="$status['first_conversation_done'] ? 'heroicon-o-check-circle' : 'heroicon-o-square'"
