 ...
 * (and haman:aggregate-analytics's schedule entry) are new — without this,
...
class BackfillAnalyticsCommand extends Command {
    protected $signature   = 'haman:backfill-analytics {days=90 : How many days back to backfill, inclusive of yesterday}';
