...
class Chatbot extends Model {
    ...
    protected $casts = ['widget_config'=>'array','notification_settings'=>'array','enabled_tools'=>'array','is_active'=>'boolean','reranker_enabled'=>'boolean','temperature'=>'float','retrieval_threshold'=>'float','rerank_threshold'=>'float','max_payment_link_amount'=>'float'];
