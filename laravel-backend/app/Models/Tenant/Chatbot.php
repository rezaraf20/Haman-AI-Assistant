...
class Chatbot extends Model {
    ...
    protected $fillable = ['name','type','status','system_prompt','welcome_message','fallback_response','embedding_model','llm_model','temperature','max_tokens_response','retrieval_top_k','retrieval_threshold','reranker_enabled','rerank_threshold','memory_window','widget_config','language','response_language','is_active'];
