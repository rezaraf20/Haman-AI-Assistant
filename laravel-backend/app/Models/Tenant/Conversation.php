...
class Conversation extends Model {
    ...
    protected $fillable = ['chatbot_id','session_id','visitor_id','status','language','page_url','referrer','ip_country','device_type','browser','message_count','total_tokens','is_converted','pending_lead_question','ended_at','started_at'];
