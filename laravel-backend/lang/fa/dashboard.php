...
return [
    ...
    'customer_chart_intents' => 'نیت‌ها در طول زمان (۳۰ روز گذشته)',
    'customer_chart_intents_empty' => 'هنوز سوال طبقه‌بندی‌شده‌ای ثبت نشده.',
    'intent_price' => 'قیمت',
    'intent_availability' => 'موجودی',
    'intent_comparison' => 'مقایسه',
    'intent_consultation' => 'مشاوره',
    'intent_authenticity' => 'اصالت',
    'intent_shipping' => 'ارسال',
    'intent_return' => 'بازگشت کالا',
