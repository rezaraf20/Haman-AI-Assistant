...
return [
    ...
    'step_connect_body' => 'In WordPress go to Hamman → Settings → Connection and enter these three values:',
    ...
    'trouble_firewall_fix' => 'Ask your host or security plugin to allow /wp-json/hamman/. With Wordfence or similar, add an exception for REST requests to that path.',
    ...
    'trouble_nowoo_cause' => 'The Hamman plugin is installed but WooCommerce is not active on that site.',
